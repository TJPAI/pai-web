const CACHE='pai-site-v20260918-42';
const CORE=[
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    const cache=await caches.open(CACHE);
    /* Core documents/assets are precached during install. Navigation stays
       browser-native, while repeat page loads are served locally with no
       network dependency. */
